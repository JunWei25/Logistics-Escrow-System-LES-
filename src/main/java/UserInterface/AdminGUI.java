...
public class AdminGUI extends javax.swing.JFrame {
    ...
    public AdminGUI(User currentUser) {
        initComponents();
    ...
    private void initComponents() {
        ...
        manageParcelLabel = new javax.swing.JLabel();
        ...
        manageParcelLabel.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        manageParcelLabel.setText("Manage Parcel");
        manageParcelLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                manageParcelLabelMouseClicked(evt);
            }
        });

        manageEscrowAgreementLabel.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(151, 151, 151)
                .addComponent(manageParcelLabel)
    ...
    private void manageParcelLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_manageParcelLabelMouseClicked
        // TODO add your handling code here:
        new ManagePackageGUI(currentUser).setVisible(true);
        dispose();
    }//GEN-LAST:event_manageParcelLabelMouseClicked
    ...
    private javax.swing.JLabel manageParcelLabel;
