...
public class MerkleTree {
    ...
    /**     * @implNote     * Set the transaction list to the MerkleTree object.     *      * @param tranxLst     */    
    ...
    /**     * @implNote     * Generate hashes of transactions      *      * @implSpec      * - genTranxHashLst(List<String>) : List<String>     */    
